...
class Contact extends Component{
    ...
    validate(firstname,lastname,telnum,email){
        ...
        if(this.state.touched.firstname && firstname.length>50){
        ...
        if(this.state.touched.lastname && lastname.length>50){
        ...
        if (this.state.touched.telnum && !reg.test(telnum)){
            errors.telnum='Telphone Number should contain only numbers';
        }

        if(this.state.touched.telnum && telnum.length!==10){
            errors.telnum="Telphone Number should be of 10 digits!";
        }
                    ...
                    <div className='col-12 col-md-9'>
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type='tel' id='telnum' name='telnum' placeholder='Telephone No.' value={this.state.telnum} 
                                    onChange={this.handleInputChange} onBlur={this.handleBlur('telnum')} valid={errors.telnum===''}
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type='email' id='email' name='email' placeholder='Email' value={this.state.email}
                                     onChange={this.handleInputChange} onBlur={this.handleBlur('email')} valid={errors.email===''}
